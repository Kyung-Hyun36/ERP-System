...
void CEachData::FillResultChart()
{
	...
	x[4] = (int)(width * cos((360 * (per[0] + per[1] + per[2] + per[3] + per[4]) / 100) * pi / 180)) + rectview.CenterPoint().x;
	y[4] = (int)(height * sin((360 * (per[0] + per[1] + per[2] + per[3] + per[4]) / 100) * pi / 180)) + rectview.CenterPoint().y;

	text_x[0] = static_cast<int>(width / 2 * cos((360 * per[0] / 2 / 100) * pi / 180)) + rectview.CenterPoint().x;
	text_y[0] = static_cast<int>(height / 2 * sin((360 * per[0] / 2 / 100) * pi / 180)) + rectview.CenterPoint().y;

	text_x[1] = static_cast<int>(width / 2 * cos((360 * (per[0] + per[1] / 2) / 100) * pi / 180)) + rectview.CenterPoint().x;
	text_y[1] = static_cast<int>(height / 2 * sin((360 * (per[0] + per[1] / 2) / 100) * pi / 180)) + rectview.CenterPoint().y;

	text_x[2] = static_cast<int>(width / 2 * cos((360 * (per[0] + per[1] + per[2] / 2) / 100) * pi / 180)) + rectview.CenterPoint().x;
	text_y[2] = static_cast<int>(height / 2 * sin((360 * (per[0] + per[1] + per[2] / 2) / 100) * pi / 180)) + rectview.CenterPoint().y;

	text_x[3] = static_cast<int>(width / 2 * cos((360 * (per[0] + per[1] + per[2] + per[3] / 2) / 100) * pi / 180)) + rectview.CenterPoint().x;
	text_y[3] = static_cast<int>(height / 2 * sin((360 * (per[0] + per[1] + per[2] + per[3] / 2) / 100) * pi / 180)) + rectview.CenterPoint().y;

	text_x[4] = static_cast<int>(width / 2 * cos((360 * (per[0] + per[1] + per[2] + per[3] + per[4] / 2) / 100) * pi / 180)) + rectview.CenterPoint().x;
	text_y[4] = static_cast<int>(height / 2 * sin((360 * (per[0] + per[1] + per[2] + per[3] + per[4] / 2) / 100) * pi / 180)) + rectview.CenterPoint().y;
